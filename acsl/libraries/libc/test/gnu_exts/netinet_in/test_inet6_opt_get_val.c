...
void runSuccess() {
    ...
    if (inet6_opt_init(bp, len) != -1) {
        ...
        if (inet6_opt_append(bp, len, anyint(), anyint(), 42, anyint(), &data) != -1)
            inet6_opt_get_val(data, 0, data, 42);
    }
}
...
void runFailure() {
    ...
    if (inet6_opt_init(bp, len) != -1) {
        char* data;
        if (inet6_opt_append(bp, len, anyint(), anyint(), 42, anyint(), &data) != -1)
            inet6_opt_get_val(NULL, 0, data, 42);
    }
}
...
void runFailure1() {
    ...
    if (inet6_opt_init(bp, len) != -1) {
        char* data;
        if (inet6_opt_append(bp, len, anyint(), anyint(), 42, anyint(), &data) != -1)
            inet6_opt_get_val(data, 100, data, 42);
    }
}
...
void runFailure2() {
    ...
    if (inet6_opt_init(bp, len) != -1) {
        char* data;
        if (inet6_opt_append(bp, len, anyint(), anyint(), 42, anyint(), &data) != -1)
            inet6_opt_get_val(data, 0, data, 100);
    }
}
...
void runFailure3() {
    ...
    if (inet6_opt_init(bp, len) != -1) {
        char* data;
        if (inet6_opt_append(bp, len, anyint(), anyint(), 42, anyint(), &data) != -1)
            inet6_opt_get_val(data, 0, NULL, 42);
    }
}
...
void testValues() {
    ...
    if (inet6_opt_init(bp, len) != -1) {
        char* data;
        if (inet6_opt_append(bp, len, anyint(), anyint(), 42, anyint(), &data) != -1) {
            int result = inet6_opt_get_val(data, 0, data, 42);
            //@ assert result == 42 + 0;
        }
    }
