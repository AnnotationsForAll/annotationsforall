...
#ifndef LIBC_NET_ROUTE_H_
#define LIBC_NET_ROUTE_H_
...
// FIXME: Even in glibc, the expansions of these macros, NLMSG_ACK and NLMSG_OVERRUN, are never defined. Is this on purpose?
