...
/*@ axiomatic WMemCmp {
  @ logic ℤ wmemcmp{L1,L2}(wchar_t *s1, wchar_t *s2, ℤ n)
  @   reads \at(s1[0..n - 1],L1), \at(s2[0..n - 1],L2);
  @
  @ axiom wmemcmp_zero{L1,L2}:
  @   \forall wchar_t *s1, *s2; \forall ℤ n;
  @      wmemcmp{L1,L2}(s1,s2,n) == 0
  @      <==> \forall ℤ i; 0 <= i < n ==> \at(s1[i],L1) == \at(s2[i],L2);
  @
  @ }
  @*/
...
/*@ axiomatic WMemChr {
  @ logic 𝔹 wmemchr{L}(wchar_t *s, ℤ c, ℤ n)
  @    reads s[0..n - 1];
  @ // Returns [true] iff array [s] contains character [c]
  @
  @ axiom wmemchr_def{L}:
  @   \forall wchar_t *s; \forall ℤ c; \forall ℤ n;
...
/*@ axiomatic WMemSet {
  @ logic 𝔹 wmemset{L}(wchar_t *s, ℤ c, ℤ n)
  @    reads s[0..n - 1];
  @ // Returns [true] iff array [s] contains only character [c]
  @
  @ axiom wmemset_def{L}:
  @   \forall wchar_t *s; \forall ℤ c; \forall ℤ n;
  @      wmemset(s,c,n) <==> \forall ℤ i; 0 <= i < n ==> s[i] == c;
  @ }
  @*/
...
/*@ axiomatic WcsChr {
  @ logic 𝔹 wcschr{L}(wchar_t *s, ℤ c)
  @    reads s[0..wcslen(s)];
  @ // Returns [true] iff string [s] contains character [c]
  @
  @ axiom wcschr_def{L}:
  @   \forall wchar_t *s; \forall ℤ c;
  @      wcschr(s,c) <==> \exists ℤ i; 0 <= i <= wcslen(s) && s[i] == c;
  @ }
  @*/
...
/*@ predicate valid_string{L}(char *s) =
  ...
  @   s == \null || valid_string(s);
  @
  @ predicate valid_read_string_or_null{L}(char *s) =
