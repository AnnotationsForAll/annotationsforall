...
#ifndef LIBC_SYS_SOUNDCARD_H_
#define LIBC_SYS_SOUNDCARD_H_
...
// This function is a user-implemented callback for when the system wants to flush the soundcard buffer.
// As such, it could do anything, and cannot be annotated here.
void seqbuf_dump(void);

#endif /* LIBC_SYS_SOUNDCARD_H_ */
